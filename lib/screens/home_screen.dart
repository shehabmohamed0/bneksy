      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            UserAccountsDrawerHeader(accountName: Text("benksy"), accountEmail:Text("name@benksy.com"),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 35,),
            Center(
              child: Text("الاقسام",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
            ),
            SizedBox(height: 20,),
            Departments(),
            SizedBox(height: 20,),
            Dep_Container(dep_name: 'عروض بنكسي',),
            SizedBox(height: 20,),
            Carsoul_Slider(),
            SizedBox(height: 20,),
            Dep_Container(dep_name: 'ملابس رجالي   ',),
            SizedBox(height: 20,),
            Carsoul_Slider(),
            SizedBox(height: 20,),
            Dep_Container(dep_name: 'ملابس اولادي   ',),
            SizedBox(height: 20,),
            Carsoul_Slider(),
            SizedBox(height: 20,),
            Dep_Container(dep_name: 'ملابس بناتي  ',),
            SizedBox(height: 20,),
            Carsoul_Slider(),
            SizedBox(height: 20,),
           GestureDetector(
             ...
             child:  Dep_Container(dep_name: 'الاكثر مبيعا',),
           ),
            SizedBox(height: 20,),
            Carsoul_Slider(),
